...
keys = [
   # Switch between windows
    ...
    Key([mod, "control"], "Down", lazy.layout.shrink(), desc="Grow window up"),
...
layouts = [
    ...
    #        section_left = 70
    #),
    layout.MonadTall(margin=5, border_width=2, border_focus="#bc7cf7", border_normal="#4c566a"),
    layout.MonadWide(margin=5, border_width=2, border_focus="#bc7cf7", border_normal="#4c566a"),
    layout.Bsp      (margin=5, border_width=2, border_focus="#bc7cf7", border_normal="#4c566a", fair=False),
    layout.Max(),
]
        ...
        top=bar.Bar(
            [
                ...
                widget.TextBox(
                    ...
                    background=colors[3],
                    foreground=colors[0],
                    mouse_callbacks={'Button1': lambda: qtile.cmd_spawn("dwm-power-menu")},
                    ),
                widget.TextBox(
                    text='\ue0be',
                    font="Inconsolata for powerline",
